        ...
        private void OnTriggerEnter(Collider other)
        {
            ...
            if (hitbox.ParentEntity.EntityBlock.IsBlocking && hitAngle > 90)
            {
                ...
                if (!hitbox.ParentEntity.EntityBlock.IsPerfectBlock())
                {
                    ...
                    {
                        hitbox.ParentEntity.EntityHealth.DamageHealth(parentEntity.EntityAttacking.currentAttack.healthDamage * parentEntity.EntityAttacking.damageMultiplier, parentEntity);
                    }
